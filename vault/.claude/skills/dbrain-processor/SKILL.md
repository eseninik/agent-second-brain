...
mcp__ticktick__search_tasks — Check duplicates
mcp__ticktick__get_tasks_due_this_week — Check workload
...
- `mcp__ticktick__search_tasks`
- `mcp__ticktick__get_tasks_due_this_week`
...
1. ВЫЗОВИ: mcp__ticktick__get_tasks_due_this_week
   ↓
...
Используй mcp__ticktick__search_tasks с тегом #process-goal
...
Создавай recurring tasks с тегом #process-goal (max 5-7 активных).
